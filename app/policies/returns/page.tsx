  ...
  return (
    <>
      ...
      <main className="container-page py-14 sm:py-20">
        <h1 className="text-2xl font-bold text-forest sm:text-3xl">Return & Refund Policy</h1>
        <p className="mt-4 max-w-2xl text-sm leading-relaxed text-charcoal/75">
          This is a placeholder for the Return & Refund Policy. Replace this text with the
